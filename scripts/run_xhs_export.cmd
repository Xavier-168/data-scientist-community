@echo off
rem Xiaohongshu collector wrapper (Windows). Mirrors run_xhs_export.sh contract.
setlocal
chcp 65001 >nul
...
if not defined VIDEO_LIMIT set "VIDEO_LIMIT=50"
...
"%NODE_BIN%" scripts\xiaohongshu_export.mjs
exit /b %errorlevel%
