@echo off
rem Douyin collector wrapper (Windows). Mirrors run_export.sh contract.
setlocal
chcp 65001 >nul
...
if not defined SCAN_WAIT_MS set "SCAN_WAIT_MS=600000"
if not defined SCAN_POLL_MS set "SCAN_POLL_MS=2000"
if not defined VIDEO_LIMIT set "VIDEO_LIMIT=999"
...
if not defined STALE_ROUNDS_LIMIT set "STALE_ROUNDS_LIMIT=3"
