...
export SCAN_WAIT_MS="${SCAN_WAIT_MS:-300000}"
export SCAN_POLL_MS="${SCAN_POLL_MS:-2000}"
export VIDEO_LIMIT="${VIDEO_LIMIT:-200}"
export MIN_PUBLISH_DATE="${MIN_PUBLISH_DATE:-}"
export MAX_PUBLISH_DATE="${MAX_PUBLISH_DATE:-}"
...
export STALE_ROUNDS_LIMIT="${STALE_ROUNDS_LIMIT:-6}"
export HEADLESS="${HEADLESS:-true}"
export AUTH_ONLY="${AUTH_ONLY:-false}"
