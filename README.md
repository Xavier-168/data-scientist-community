...
当前版本先支持 macOS，Windows 版本也在计划中，很快就会上线。如果这个项目对你有帮助，欢迎点一个 Star，也欢迎把你的真实使用感受和建议告诉我。

数据科学家接下来会迎来高频的更新，这将会是我未来的主要产品线，全部开源，希望可以帮助到正在做自媒体的你。

想了解更多关于逍遥的内容，以及我正在做的录播课和知识库，可以来我的一人公司官网：[https://zhaoxiaoyao.com](https://zhaoxiaoyao.com)。
...
- 社区版不包含客户数据、许可证台账、私钥、生产服务地址、历史 DMG、字体二进制或来源不明的原图标。
